...
#前端/用户上传数据库（待审核）
class Test_Chem_mol(models.Model):
    ...
    _1D_NMR_Spectra = models.CharField(max_length=200, default=0, verbose_name="一维核磁共振波谱")  # 一维核磁共振波谱
    _2D_NMR_Spectra = models.CharField(max_length=200, default=0, verbose_name="2D_NMR_波谱")  # 2D_NMR_波谱
    ...
    class Meta:
        verbose_name = '待审核化学分子信息'
        verbose_name_plural = '待审核化学分子数据库'
        #db_table = 'Chem_Test_mol'   #在数据库中的表名
